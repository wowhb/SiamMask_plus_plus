...
parser.add_argument('--config', dest='config', default='config_davis.json',
                    help='hyper-parameter of SiamMask_plus_plus in json format')
...
if __name__ == '__main__':
    ...
    siammask_plus_plus = Custom(anchors=cfg['anchors'])
    if args.resume:
    ...
    for f, im in enumerate(ims):
        ...
        if f == 0:  # init
            ...
            state = siamese_init(im, target_pos, target_sz, siammask_plus_plus, cfg['hp'], device=device)  # init tracker
        elif f > 0:  # tracking
